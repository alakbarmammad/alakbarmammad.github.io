...
import { Mail, MapPin, Briefcase, GraduationCap, Code2, Globe2, User } from "lucide-react";
...
export default function CV() {
  const [match, params] = useRoute("/:lang/cv");
  const lang = (params?.lang as Language) || 'en';
  const t = content[lang]?.cv || content.en.cv;

  return (
    <Layout>
      <div className="py-8 space-y-12 max-w-4xl mx-auto">
        {/* Header Section */}
        <div className="flex flex-col md:flex-row gap-8 items-start border-b border-border pb-8">
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-background shadow-lg shrink-0">
             <img src={avatarImage} alt="Profile" className="w-full h-full object-cover" />
          </div>
          
          <div className="flex-1 space-y-4">
            <div>
              <h1 className="text-3xl font-bold">{t.personal.name}</h1>
              <p className="text-lg text-muted-foreground">{content[lang]?.home.title}</p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              {t.socialMedia?.facebook && (
                <a href={t.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#FFFFFF]/10 hover:bg-[#FFFFFF]/20 transition-colors" title="Facebook">
                  <FacebookIcon />
                </a>
              )}
              {t.socialMedia?.instagram && (
                <a href={t.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-[#FFFFFF] to-[#FFFFFF] hover:opacity-90 transition-opacity" title="Instagram">
                  <InstagramIcon />
                </a>
              )}
              {t.socialMedia?.linkedin && (
                <a href={t.socialMedia.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#FFFFFF]/10 hover:bg-[#FFFFFF]/20 transition-colors" title="LinkedIn">
                  <LinkedInIcon />
                </a>
              )}
              {t.socialMedia?.tiktok && (
                <a href={t.socialMedia.tiktok} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#FFFFFF]/10 hover:bg-[#FFFFFF]/20 transition-colors dark:bg-[#FFFFFF]/10 dark:hover:bg-[#FFFFFF]/20" title="TikTok">
              ...
              {t.socialMedia?.blog && (
                <a href={t.socialMedia.blog} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#FFFFFF]/10 hover:bg-[#FFFFFF]/20 transition-colors" title="Blog">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr,2fr] gap-12">
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {t.skillsList.map((skill, i) => (
                  <span key={i} className="text-xs font-medium bg-secondary/50 border border-border/50 px-2.5 py-1 rounded-md">
                    {skill}
                  </span>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {t.languages.map((lang, i) => (
                  <div key={i} className="flex justify-between items-center text-sm border-b border-border/40 pb-2 last:border-0">
                    ...
                    <span className="text-muted-foreground text-xs bg-secondary px-2 py-0.5 rounded">{lang.level}</span>
                  </div>
                ))}
              </div>
            </section>
              ...
              <div className="space-y-4">
                {t.education.map((edu, i) => (
                  <div key={i}>
                    ...
                    <p className="text-xs text-muted-foreground/80 mt-1">{edu.period}</p>
                  </div>
                ))}
              </div>
            </section>
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-8 border-l-2 border-border/50 ml-2 pl-8 relative">
                {t.experience.map((job, i) => (
                  <div key={i} className="relative group">
                    <div className="absolute -left-[39px] top-1.5 w-4 h-4 rounded-full bg-background border-2 border-primary group-hover:bg-primary transition-colors" />
                    <div className="mb-2">
                      <h3 className="text-lg font-bold text-foreground">{job.role}</h3>
                      <div className="flex flex-wrap justify-between items-center text-sm mt-1 mb-3 gap-2">
                        <span className="font-medium text-primary">{job.company}</span>
                        <div className="flex gap-2 text-xs text-muted-foreground">
                           <span className="bg-secondary px-2 py-0.5 rounded">{job.period}</span>
                           <span>•</span>
